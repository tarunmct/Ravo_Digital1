...
const Service = () => {
  return (
    <>
      <div className="container mx-auto px-4 pb-12 pt-2 overflow-hidden">
        {/* Header Section */}
        <motion.div 
          initial={{opacity:0}}
        ...
        <div className="hidden lg:block relative max-w-7xl mx-auto py-20 lg:py-28">
          ...
          <motion.div 
            ...
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100 relative z-20">
          ...
          <motion.div 
            ...
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100 relative z-20">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 lg:-mb-6 -ml-3' src={StrategyImg} alt="Strategy" />
          ...
          <motion.div 
            ...
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100 relative z-20">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 lg:-mb-6 -ml-3' src={LaunchImg} alt="Launch" />
          ...
          <motion.div 
            ...
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100 relative z-20">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 lg:-mb-6 -ml-3' src={ExecuteImg} alt="Execute" />
        ...
        <div className="lg:hidden mt-12 space-y-6">
          <motion.div 
            ...
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100">
          ...
          <motion.div 
            ...
            className='max-w-[350px] mx-auto'>
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 -ml-3' src={StrategyImg} alt="Strategy" />
          ...
          <motion.div 
            ...
            className='max-w-[350px] mx-auto'>
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 -ml-3' src={LaunchImg} alt="Launch" />
          ...
          <motion.div 
            ...
            className='max-w-[350px] mx-auto'>
            <div className="bg-white rounded-2xl px-6 pt-2 pb-6 shadow-lg border border-gray-100">
              <img className='w-28 lg:w-32 -mt-4 -mb-4 -ml-3' src={ExecuteImg} alt="Execute" />
