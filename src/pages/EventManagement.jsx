          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-gray-50 rounded-3xl p-10 shadow-xl border border-gray-100 text-center relative"
              >
                ...
                <div className="flex flex-col items-center">
                  <img
                    ...
                    className="w-20 h-20 rounded-full object-cover border-4 border-[#fdcd2d] mb-4 shadow-lg"
                    loading="lazy"
                  />
